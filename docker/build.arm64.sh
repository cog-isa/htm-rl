...
docker build \
    ...
    --cache-from=pkuderov/htm-core-fork:arm64 \
    --tag pkuderov/htm-core-fork:arm64 \
...
docker build \
    ...
    --build-arg BUILDKIT_INLINE_CACHE=1 \
    --cache-from=pkuderov/htm-core-fork:arm64 \
    --cache-from=pkuderov/hima:arm64 \
    --tag pkuderov/hima:arm64 \
    -f $script_dir/Dockerfile.arm64 \
    $PWD

# Push the new versions:
docker push pkuderov/htm-core-fork:arm64
docker push pkuderov/hima:arm64